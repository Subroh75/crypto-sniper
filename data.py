"""
data.py â Unified data layer for Crypto Sniper
...
# ââ API Keys (set in Render environment variables) ââââââââââââââââââââââââââ
...
# ââ Base URLs ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
# ââ Symbol maps âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
CG_ID = {
...
def get_ohlcv(symbol: str, interval: str = "1H") -> list[list]:
    ...
    data    = _cg_headers_requests(url, {"vs_currency":"usd","days":days,"precision":8})
...
# ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
# 3. TECHNICAL INDICATORS  (Twelve Data â pre-computed, free 800/day)
# ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
# ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
# 4. TRENDING + GAINERS/LOSERS  (CoinGecko â free, no key)
# ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
@lru_cache(maxsize=1)
...
def _gainers_cached(ts: int) -> dict:
    """Top gainers + losers â requires CG Pro key."""
    if not CG_KEY:
...
# ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
# 6. BTC ON-CHAIN  (Mempool.space â free, no key)
# ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
@lru_cache(maxsize=1)
...
# ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
# 7. ETH ON-CHAIN  (Etherscan â free, 5 calls/sec)
# ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
@lru_cache(maxsize=1)
...
# ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
# 8. NEWS FEED  (MarketAux â free 100 req/day)
# ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
def _rss_news_fallback(symbol: str) -> list:
    """RSS fallback â CoinDesk for BTC/ETH, CoinTelegraph for others."""
    import feedparser
    feeds = {
...
# ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
# 9. MACRO DATA  (Econdb â free, no key for common series)
# ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
@lru_cache(maxsize=1)
